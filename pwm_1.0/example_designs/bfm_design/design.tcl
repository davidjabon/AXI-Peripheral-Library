proc create_ipi_design { offsetfile design_name } {
	...
	set pwm_0 [ create_bd_cell -type ip -vlnv depaul.edu:user:pwm:1.0 pwm_0]
	...
	set offset_file "${bd_path}/pwm_v1_0_tb_include.vh"
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores depaul.edu:user:pwm:1.0]]]]
set test_bench_file ${ip_path}/example_designs/bfm_design/pwm_v1_0_tb.v
